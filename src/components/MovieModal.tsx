          ...
          <>
            ...
            <ModalBody>
              <div className="flex flex-col gap-6">
                {embedUrl && (
                  <div className="relative w-full rounded-lg overflow-hidden bg-zinc-800" style={{ paddingBottom: '56.25%' }}>
                    <iframe
                      src={embedUrl}
                      title={movie.title}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Gênero</h3>
                    <span className="bg-zinc-800 text-zinc-300 px-3 py-1 rounded-full text-sm">
                      {movie.genre}
                    </span>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Diretor</h3>
